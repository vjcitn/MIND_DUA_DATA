---
title: "MIND Trial Blood Pressure"
author: "NIA MIND Trial Data Coordinators"
date: "`r format(Sys.time(), '%B %d, %Y')`"
vignette: >
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteIndexEntry{MIND Trial Blood Pressure}
...
# MIND Blood Pressure Data Archive

```{r lk1,echo=FALSE,results="hide",message=FALSE}
library(htmltools)
library(R.utils)
fis = getAbsolutePath(dir("Blood_Pressure", full=TRUE))
